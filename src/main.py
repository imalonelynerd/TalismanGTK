...
from .window import TalismanGtkWindow


class TalismanGtkApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='fr.imalonelynerd.Talisman',
    ...
    def do_activate(self):
        ...
        if not win:
            win = TalismanGtkWindow(application=self)
        win.present()

    def on_about_action(self, widget, _):
        """Callback for the app.about action."""
        about = Adw.AboutWindow(transient_for=self.props.active_window,
                                application_name='Talisman',
                                comments='A stupid simple, yet elegant YuGiOh! companion app.',
                                application_icon='fr.imalonelynerd.Talisman',
                                developer_name='Nerd',
                                version='0.0.1 Droll',
                                developers=['Nerd'],
